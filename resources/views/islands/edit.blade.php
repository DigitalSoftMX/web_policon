        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-7 mx-auto d-block mt-3">
                    <form method="post" action="{{ route('islands.update', [$station, $island]) }}" autocomplete="off"
                                ...
                                <div class="row">
                                    <div class="form-group{{ $errors->has('island') ? ' has-danger' : '' }} col-sm-6">
                                        ...
                                        <input type="number"
                                            ...
                                            placeholder="Escribe el numero de la isla"
                                            value="{{ old('island', $island->island) }}" aria-required="true" name="island">
                                    ...
                                    <div class="form-group{{ $errors->has('bomb') ? ' has-danger' : '' }} col-sm-6">
                                        ...
                                        <input type="number"
                                            ...
                                            id="input-bomb" value="{{ old('bomb', $island->bomb) }}" aria-required="true"
