                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }} col-sm-6">
                                        ...
                                        <input type="text"
                                            ...
                                            id="input-name" aria-describedby="nameHelp"
                                            placeholder="Escribe la dirección de la estación"
                                            value="{{ old('address', $station->address) }}" aria-required="true"
                                            name="address">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }} col-sm-6">
                                        ...
                                        <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"
                                            ...
                                            value="{{ old('email', $station->email) }}" aria-required="true"
                                            aria-describedby="emailHelp" placeholder="Escribe el email de la estación"
                                            aria-required="true">
                                        @if ($errors->has('email'))
                                ...
                                <div class="row mt-3">
                                    <div
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('number_station', $station->number_station) }}"
                                            aria-required="true" name="number_station">
                                    ...
                                    <div class="form-group{{ $errors->has('abrev') ? ' has-danger' : '' }} col-sm-6">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('abrev', $station->abrev) }}" aria-required="true" name="abrev">
                                        @if ($errors->has('abrev'))
                                            <span id="abrev-error" class="error text-danger" for="input-abrev">
                                                {{ $errors->first('abrev') }}
                                            </span>
                                        @endif
                                    </div>
