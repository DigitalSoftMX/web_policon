        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-7 mx-auto d-block mt-3">
                    <form method="post" action="{{ route('vouchers.update', $voucher) }}" autocomplete="off"
                                ...
                                <div class="row">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} col-sm-6">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Escribe el nombre del vale"
                                            value="{{ old('name', $voucher->name) }}" aria-required="true" name="name">
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="form-group{{ $errors->has('points') ? ' has-danger' : '' }} col-sm-6">
                                        ...
                                        <input type="number"
                                            ...
                                            placeholder="Escribe el número de puntos del vale"
                                            value="{{ old('points', $voucher->points) }}" aria-required="true"
                                            name="points">
                                ...
                                <div class="row mt-3">
                                    <div class="form-group{{ $errors->has('value') ? ' has-danger' : '' }} col-sm-6">
                                        ...
                                        <input type="number"
                                            ...
                                            placeholder="Escribe el valor del vale"
                                            value="{{ old('value', $voucher->value) }}" aria-required="true" name="value">
                                        @if ($errors->has('value'))
                                    ...
                                    <div class="form-group{{ $errors->has('id_status') ? ' has-danger' : '' }} col-sm-6">
                                        ...
                                        <select id="input-id_status" name="id_status"
                                            ...
                                            @foreach ($status as $s)
                                                @if ($voucher->id_status == $s->id)
                                                    <option value="{{ $s->id }}" selected>{{ $s->name_status }}</option>
                                                @else
                                    ...
                                    <div class="form-group{{ $errors->has('id_station') ? ' has-danger' : '' }} col-sm-6">
                                        ...
                                        <select id="input-id_station" name="id_station"
                                            ...
                                            @foreach ($stations as $station)
                                                @if ($voucher->id_station == $station->id)
